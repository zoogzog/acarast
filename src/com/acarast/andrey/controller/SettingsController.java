...
/**
 * Class to store all default settings for the image processing algorithm.
 * @author Andrey G
 */
...
public class SettingsController
{
	...
	public static final int DEFAULT_CELL_DETECTOR_MIN_BACTERIA_SIZE = 3;
	 ...
	 * Allowed values: 0 - 10*/
	public static final int DEFAULT_CELL_DETECTOR_MAX_CELL_DISTANCE = 2;
